...
describe('test parametersMaps function', () => {
    ...
    describe('basic command error', () => {
        ...
        test.each(testCases)('%s', (name, testData) => {
            ...
            expect(t).toThrow((data.apiParam.parameters?.expected as string) ?? helper.randomString(20));
        });
    });
    ...
    //     // test case required 2 parametersMaps per test
    //     const testCases = getTestCases('./src/test/data/parametersMaps-random.json', 2);

    //     test.each(testCases)('%s', (name, testData) => {
    //         const data = testData as TestData;

    //         MapsHelper.applyParametersMaps(data.apiParam, data.sessionData, data.parametersMaps);
    //         // console.log('data.apiParam', data.apiParam)

    //         // target property must be created
    //         expect(((data.apiParam.httpHeaders?.random as string) ?? undefined).length).toEqual(data.apiParam.parameters?.expected ?? helper.randomString(20));
    //     });
    // });
    // describe('random command error', () => {
    //     // test case required 2 parametersMaps per test
    //     const testCases = getTestCases('./src/test/data/parametersMaps-random-error.json', 2);
    ...
    // describe('basicAuth command', () => {
    //     // test case required 2 parametersMaps per test
    //     const testCases = getTestCases('./src/test/data/parametersMaps-basicAuth.json', 2);

    //     test.each(testCases)('%s', (name, testData) => {
    //         const data = testData as TestData;

    //         // make sure that the target property not define yet
    //         expect(data.apiParam.httpHeaders?.basicAuth ?? undefined).toBeUndefined();

    //         MapsHelper.applyParametersMaps(data.apiParam, data.sessionData, data.parametersMaps);

    //         // target property must be created
    //         expect(data.apiParam.httpHeaders?.basicAuth ?? undefined).toEqual(data.apiParam.parameters?.expected ?? helper.randomString(20));
    //     });
    // });

    // describe('basicAuth command error', () => {
    //     // test case required 2 parametersMaps per test
    //     const testCases = getTestCases('./src/test/data/parametersMaps-basicAuth-error.json', 2);
    ...
    // describe('apexAuth command', () => {
    //     // test case required 2 parametersMaps per test
    //     const testCases = getTestCases('./src/test/data/parametersMaps-apexAuth.json', 1);

    //     test.each(testCases)('%s', (name, testData) => {
    //         const data = testData as TestData;

    //         // make sure that the target property not define yet
    //         expect(data.apiParam.httpHeaders?.apexAuth ?? undefined).toBeUndefined();

    //         MapsHelper.applyParametersMaps(data.apiParam, data.sessionData, data.parametersMaps);

    //         // target property must be created
    //         expect(data.apiParam.httpHeaders?.apexAuth ?? undefined).toBeDefined();
    //     });
    // });

    // describe('apexAuth command error', () => {
    //     // test case required 2 parametersMaps per test
    //     const testCases = getTestCases('./src/test/data/parametersMaps-apexAuth-error.json', 2);
