...
import { ApiParam, ApiTag, ResponseParam, ApiCommand } from './apiLibClass.js';
export class ApiLibBase {
    constructor(cluster) {
                    ...
                    if (apiParam.nextHopOnly) {
                        ...
                        if (apiParam.httpMethod === 'POST' || apiParam.httpMethod === 'PUT') {
                            ...
                            if (apiParam.formData != undefined) {
                                const postData = qs.stringify(apiParam.formData, undefined, undefined, {
                                    encodeURIComponent: encodeURIComponent,
                                });
                                req = req
...
ApiLibBase.maskList = [];
//# sourceMappingURL=apiLibBase.js.map